...
void GUI_Init_Curr_Elems(bool);
void GUI_Reset_GUI( void );

#if defined(RP2040_M0_1) || defined(CORE1_SIM)
    extern const char     LVGL_VersinfoStr1[];   /* ptr to LVGL version info str    */
    ...
    extern const char     *LVGL_VersinfoStr0;     /* ptr to LVGL version info str    */
