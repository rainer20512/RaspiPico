...
//
//  Copyright (c) 2001-2025 Rowley Associates Limited.
//
...
1:
  ...
  bl memory_copy
  // RHB added to copy mutexes
  ldr r0, =__mutex_load_start__
  ldr r1, =__mutex_start__
  ldr r2, =__mutex_end__
  bl memory_copy
...
/* RHB Inserted from original crt0.S */
// ----------------------------------------------------------------------------
